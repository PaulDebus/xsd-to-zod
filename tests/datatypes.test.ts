...
import { irToZod, parseXsd, parseXml, safeParseXml, serializeXml } from '../src/index.js';
import {
  xsdBase64Binary,
  xsdDate,
  xsdDateTime,
...
describe('xsdLexicals validators', () => {
  it('xs:date', () => {
    cases(xsdDate,
      ['2002-10-10', '2002-10-10Z', '2002-10-10+05:00', '2002-10-10-05:00', '2002-10-10+14:00',
        '-2002-10-10', '12002-10-10', '2000-02-29', ' 2002-10-10 '],
      ['2002-13-10', '2002-00-10', '2002-10-32', '2002-10-00', '2002-02-30', '2001-02-29', '1900-02-29',
        '0000-10-10', '2002-10-10+14:01', '2002-10-10+15:00', '2002-1-10', '2002-10-10T00:00:00', '', 'abc']);
  });

  it('xs:dateTime', () => {
    cases(xsdDateTime,
      ['2002-10-10T12:00:00', '2002-10-10T12:00:00.5', '2002-10-10T12:00:00Z',
        '2002-10-10T12:00:00-05:00', '2002-10-10T12:00:00+14:00', '2002-10-10T24:00:00', '-2002-10-10T00:00:00'],
      ['2002-13-45T99:99:99', '2002-10-10T25:00:00', '2002-10-10T24:00:01', '2002-10-10T24:00:00.1',
        '2002-10-10 12:00:00', '2002-02-30T00:00:00', '2002-10-10T12:00:00+15:00',
        '2002-10-10T12:00', '2002-10-10T12:00:60', '', '2002-10-10']);
  });

  it('xs:time', () => {
    cases(xsdTime,
      ['12:00:00', '24:00:00', '24:00:00.0', '23:59:59Z', '12:00:00.123+14:00', '00:00:00-14:00'],
      ['24:00:01', '25:00:00', '12:60:00', '12:00:60', '12:00', '12:00:00+14:01', '12:00:00.', '', '12:00:00+5:00']);
  });

  it('xs:duration', () => {
    cases(xsdDuration,
      ['P1Y', '-P1Y', 'P1Y2M3DT4H5M6S', 'PT0.5S', 'P0D', 'PT10H', 'P1DT2H', 'PT1M', 'P1347M', 'P1Y2D'],
      ['P', '-P', 'PT', 'P1YT', 'P1D2Y', 'P1S', '1Y', 'PT1Y', 'P1Y2M3DT4H5M6', 'P1.5Y', '', 'P1X']);
  });

  it('xs:gYear', () => {
    cases(xsdGYear, ['2002', '-2002', '2002Z', '12002', ' 2002 '], ['0000', '02', '2002-10', '2002Z2', '']);
  });

  it('xs:gYearMonth', () => {
    cases(xsdGYearMonth, ['2002-10', '-2002-10', '2002-10+05:00'], ['0000-10', '2002-13', '2002-00', '2002', '']);
  });
  ...
  it('xs:gMonthDay', () => {
    cases(xsdGMonthDay, ['--10-10', '--02-29', '--12-31Z'], ['--02-30', '--11-31', '--1-10', '--10-1', '--13-01', '']);
  });
  ...
  it('xs:base64Binary', () => {
    cases(xsdBase64Binary, ['', 'QUJD', 'QUJDRA==', 'QUJD RA==', ' Q U J D '],
      ['QUJD=', 'QUJDRA=', 'QUJD==', 'QUJ', 'QUJD====', 'QUJ$', '====']);
  });

  it('xs:language', () => {
    cases(xsdLanguage, ['en', 'e', 'en-US', 'de-CH-1901', 'i-klingon', 'x-private'],
      ['en-', 'en_US', '123', 'toolonglang', 'en--US', '']);
  });

  it('xs:Name', () => {
    cases(xsdName, ['foo', ':foo', 'a.b-c_d', 'élan', '_x'],
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
    ...
    expect(code).toContain("import { xmlRegistry, xsdDateTime, xsdDuration, xsdNCName } from 'xsd-to-zod';");
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  const importRoot = async (): Promise<z.ZodType> => {
    ...
    if (root === undefined) throw new Error('no root schema generated');
    return root;
  };
  ...
  it('accepts valid lexicals and preserves the original strings', async () => {
    ...
    expect(parsed).toEqual({ when: '2002-10-10T12:00:00-05:00', span: '-P1Y', b: -128 });
