...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="urn:t" xmlns:t="urn:t">
  <xs:element name="root"/>
    ...
    const xml = '<t:root xmlns:t="urn:t" xmlns:o="urn:other"><t:child a="1">text</t:child><o:item>x</o:item><o:item>y</o:item></t:root>';
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:complexType name="ct">
    ...
    expect(parseXml(schema, '<root><a></a><b></b></root>')).toEqual({ a: 'default', b: 'fixed' });
  });
