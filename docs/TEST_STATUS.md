...
- [x] W3C sun/ms selection (2,296 valid-instance cases from 18 test sets; 2,009 passing, 286 pinned as `it.fails` with categorized reasons in `tests/w3cKnownFailures.ts`)
