...
- [x] W3C sun/ms selection (2,312 valid-instance cases from 18 test sets; 1,851 passing, 461 pinned as `it.fails` with categorized reasons in `tests/w3cKnownFailures.ts`)
