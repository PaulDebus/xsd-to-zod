...
- [x] W3C sun/ms selection (2,296 valid-instance cases from 18 test sets; 1,950 passing, 345 pinned as `it.fails` with categorized reasons in `tests/w3cKnownFailures.ts`)
